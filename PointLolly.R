PointLolly <- function(TweeSeizoenen){
  ...
  p <- ggplot(TweeSeizoenen) +
    ...
    #theme_fivethirtyeight() +
     ...
     theme(plot.background = element_rect(fill = "#BFDFAD"),
  panel.background = element_rect(fill = "#BFDFAD", colour = "#BFDFAD",
                                  size = 2, linetype = "solid"),
  panel.grid.major = element_line(color = "#007522"),
  panel.grid.minor = element_line(color = "#007522"),
